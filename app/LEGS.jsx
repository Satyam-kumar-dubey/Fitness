    ...
    <View style={styles.main}>
      ...
      <ScrollView>
        ...
        >
          ...
          >
            <Image
              source={require("../assets/images/leg1.gif")}
          ...
          >
            <Image
              source={require("../assets/images/leg2.gif")}
              style={{ height: "100%", width: "100%" }}
            />
          </View>
          <View
          ...
          >
            <Image
              source={require("../assets/images/leg3.gif")}
              style={{ height: "100%", width: "100%" }}
            />
          </View>
          <View
          ...
          >
            <Image
              source={require("../assets/images/leg4.gif")}
              style={{ height: "100%", width: "100%" }}
            />
          </View>
          <View
          ...
          >
            <Image
              source={require("../assets/images/leg5.gif")}
              style={{ height: "100%", width: "100%" }}
            />
          </View>
          <View
          ...
          >
            <Image
              source={require("../assets/images/leg6.gif")}
              style={{ height: "100%", width: "100%" }}
            />
          </View>
        </View>
